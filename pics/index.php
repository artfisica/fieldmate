...
<html xmlns:fb="http://www.facebook.com/2008/fbml">
  <head>
    <meta charset="UTF-8">
    <title>Login Hackathon 2016</title>
...
<div class="hero-unit">
  ...
  <p>Welcome to Data Taking and Visualisation Portal</p>
  </div>
<div class="span4">
 <ul class="nav nav-list">
<li class="nav-header">Image</li>
	<li><img src="https://graph.facebook.com/<?php echo $_SESSION['FBID']; ?>/picture"></li>
<li class="nav-header">Personal ID</li>
...
<CENTER>
  <a href="http://universidad.ch/dataholics/tasks.php" style="background-color:rgb(61,148,0);
   ...
   white-space:nowrap;
   color:white!important">My Tasks</a>


  <a href="http://universidad.ch/dataholics/teammap.php" style="background-color:rgb(61,148,0);
   background-image:-webkit-linear-gradient(top,rgb(0,255,0),rgb(80,200,80));
   border:1px solid rgba(0,0,0,0);
   border-bottom-left-radius:2px;
   border-bottom-right-radius:2px;
   border-top-left-radius:2px;
   ...
   text-transform:uppercase;
   white-space:nowrap;
   color:white!important">Team Map</a>


    <a href="http://universidad.ch/dataholics/summary.php" style="background-color:rgb(61,148,0);
     background-image:-webkit-linear-gradient(top,rgb(255,0,0),rgb(200,80,80));
     border:1px solid rgba(0,0,0,0);
     border-bottom-left-radius:2px;
     border-bottom-right-radius:2px;
     border-top-left-radius:2px;
     ...
     text-transform:uppercase;
     white-space:nowrap;
     color:white!important">Data Summary</a>
   </CENTER>
</br>
</br>
</br>
